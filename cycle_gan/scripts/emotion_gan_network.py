...
class Generator(nn.Module):
    ...
    def forward(self, x):
        ...
        # (Batch_size, 32, 11 , 11)
        x6 = self.conv1T(x5, output_size=(x.shape[0], 32, 11, 11))
        ...
        x7 = self.conv2T(x6_stack, output_size=(
            x.shape[0], 32, 23, 23))  # (Batch_size, 32, 23, 23)
        ...
        x9 = self.conv3T(x8_stack, output_size=(
            x.shape[0], 1, 48, 48))  # (Batch_size, 1, 48, 48)
